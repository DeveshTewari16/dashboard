  ...
  return (
    <div className="user">
      <div className="userTitleContainer">
        <h1 className="userTitle">Edit User Data</h1>
        <Link to="/newUser">
        ...
        <div className="userShow">
          ...
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">Devesh</span>
            </div>
            <div className="userShowInfo">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">+91 9898239821</span>
            </div>
            <div className="userShowInfo">
              <MailOutline className="userShowIcon" />
              <span className="userShowInfoTitle">devesh@gmail.com</span>
            </div>
            <div className="userShowInfo">
